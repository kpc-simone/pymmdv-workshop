...
def plot_escaping_bouts(ax,trajectory_dir,color,speed_thresh=10,min_bout_duration=1.0):
...
if __name__ == '__main__':
    ...
    color = 'dodgerblue'
    speed_mad = 2.0            # assumes mm/s

    plt.style.use('../multipanel_style.mplstyle')
    fig,ax = plt.subplots(1,1)
    plot_escaping_bouts(ax,trajectory_dir,color,speed_mad=speed_mad,baseline_window=(60,240))
    fig.tight_layout()
    plt.show()
